...
noteStyleAra <- createStyle(fontName = "Arial Narrow", fontSize = 16,
                         halign = "right", fgFill = "#fcfcfc", 
                         textDecoration = "bold", border = c("top","bottom","left","right"), 
                         borderColour = "black", borderStyle = "thin")
...
if (relevancySelection == "Included"){
    ...
    #Arabic
    for (i in noteSectionListAra){
       addStyle(wb, sheet = "paperArabic", noteStyleAra, rows = i + 2, cols = 1:5, gridExpand = F)
    }
    ...
    #Arabic
    for (i in noteSectionListAra){
       addStyle(wb, sheet = "paperArabic", noteStyleAra, rows = i + 2, cols = 1:4, gridExpand = F)
    }
